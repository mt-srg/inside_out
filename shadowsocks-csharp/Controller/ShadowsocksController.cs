...
namespace Shadowsocks.Controller
{
    ...
    public class ShadowsocksController
    {
        ...
        public int preSysProxyMode;
        public int preProxyRuleMode;
#if !_CONSOLE
        ...
        // func for click on Private PAC
        public void TogglePACPrivate(bool enabled)
        {
            if (enabled)
            {
                preProxyRuleMode = _config.sysProxyMode;
                preSysProxyMode = _config.proxyRuleMode;
                _config.sysProxyMode = 2;
                _config.proxyRuleMode = 0;
            }
            else
            {
                _config.sysProxyMode = preProxyRuleMode;
                _config.proxyRuleMode = preSysProxyMode;
            }
            _config.pacPrivate = enabled;
            SaveConfig(_config);
        ...
        protected void Reload()
        {
            ...
            // load pac_private.txt first
            PACPrivateServer.LoadPACPrivateFile();
            ...
            if (_pacServer == null)
            {
                ...
                // when pac_private file changes, reload it to dict.
                _pacServer.PACPrivateFileChanged += pacServer_PACPrivateFileChanged;
            }
        ...
        //reload pac_private.txt to dict
        private void pacServer_PACPrivateFileChanged(object sender, EventArgs e)
        {
            PACPrivateServer.LoadPACPrivateFile();
            UpdatePACFromGFWList();
        }
