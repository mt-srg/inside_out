...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        //button for private pac mode
        private MenuItem PACPrivateItem;
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                ...
                PACPrivateItem = CreateMenuItem("Private PAC", new EventHandler(this.PACPrivateItem_Click)),
                ...
                CreateMenuGroup("Help", new MenuItem[] {
                    ...
                    CreateMenuItem("Inside out...", new EventHandler(this.OpenInsideOut_Click)),
        ...
        private void LoadCurrentConfiguration()
        {
            ...
            PACPrivateItem.Checked = config.pacPrivate;
        ...
        private void OpenInsideOut_Click(object sender, EventArgs e)
        {
            Process.Start("http://123.56.46.220:8080/");
        }
        ...
        private void PACPrivateItem_Click(object sender, EventArgs e)
        {
            PACPrivateItem.Checked = !PACPrivateItem.Checked;
            controller.TogglePACPrivate(PACPrivateItem.Checked);
        }
